...
class LiveCart extends React.Component {
    ...
    componentWillMount() {
        ...
        socket.on('update-live-cart-disply', liveCart => {
            this.setState({ liveTransactions: liveCart})
        });
    }
    render() {
        let { transactions, liveTransactions } = this.state;
        let renderRecentTransaction = () => {
            if (transactions.length == 0) {
            return <p>No recent transaction</p>;
            }
            else {
                        ...
                        <div className="col-md-5 pull-left">
                            <div className="panel panel-default">
                                ...
                                <div className="panel-body">
                                    <div className="text-center"><span>Today's Sales</span> <br/>
                                ...
                                <table className="table table-hover table-striped">
                                    ...
                                    <tbody>{renderRecentTransaction()}</tbody>
                                </table>
                                </div>
                            </div>
                        </div>
